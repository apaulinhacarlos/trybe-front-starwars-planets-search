# Boas vindas ao repositório do projeto de Starwars Planets Search em context api e hooks!
...
```bash
git clone git@github.com:apaulinhacarlos/trybe-front-starwars-planets-search/.git
```

Acesse o diretório do projeto com o comando `cd`:

```bash
cd trybe-front-starwars-planets-search
```
...
A API a ser consultada está [nesse link](https://swapi.dev/api/planets). Ou seja, você deverá fazer um fetch para a URL `https://swapi.dev/api/planets`
